...
'to verify if another page shows up after try to login with empty password'
WebUI.verifyElementText(findTestObject('Page_Facebook  log in or sign up/we will send you a code'), 'We\'ll send you a code to your email address')
